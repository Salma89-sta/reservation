        ...
        child: Padding(
          ...
          child: Form(
            ...
            child: Column(
              ...
              const SizedBox(height: 5,),
              BlocProvider(
          create: (context) => AdditionalOptionsCubit()..getAdditionalOptions(widget.itemId),
          child: ChecklistPage(),
        ),
                ...
                Button0(widget: Center(child: Text('تأكيد الحجز', style: TextStyle(color: Colors.white, fontSize: 20.sp, fontWeight: FontWeight.bold),)), function: _addReservation)
